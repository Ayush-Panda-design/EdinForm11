...
function EdinburghSkylineHero() {
  ...
  landmarks.forEach((l) => {
    tooltipData[l.id] = { label: l.label, sub: l.sub, color: l.color };
  });
        ...
        >
          <div
            style={{
              fontSize: "13px",
              fontWeight: 700,
              color: tooltipData[hovered]!.color,
          ...
          return (
            ...
            >
              ...
              <text
                ...
                style={{
                  fontSize: "16px",
                  fill: isPast ? color : "rgba(255,255,255,0.3)",
              ...
              <text
                ...
                style={{
                  fontSize: "12px",
                  fontWeight: 700,
                  fill: isPast ? "var(--foreground, #E8D5B0)" : "rgba(255,255,255,0.4)",
                  fontFamily: "'Cormorant Garamond', serif",
                  transition: "fill 0.4s",
                }}
              >
  ...
  const nodes = [
    {
      ...
      w: 200,
      h: 36,
      label: "Do you collect feedback regularly?",
      type: "q",
      color: "#C89B63",
    },
    {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{
            background: "rgba(126,184,132,0.12)",
            border: "1px solid rgba(126,184,132,0.2)",
            borderRadius: "10px",
            padding: "5px 10px",
            fontSize: "11px",
            color: "#7EB884",
      ...
      >
        ...
        >
          <path
            ...
            fill="rgba(200,155,99,0.05)"
            stroke="rgba(200,155,99,0.2)"
            strokeWidth="1"
          />
        </svg>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          style={{ fontFamily: "monospace", fontSize: "11px", color: "var(--muted-foreground)" }}
        >
          ...
          {steps.map((_, i) => (
            <div
              ...
              style={{
                ...
                borderRadius: "999px",
                background:
                  i < step ? "#7EB884" : i === step ? "#C89B63" : "rgba(255,255,255,0.12)",
                transition: "all 0.3s",
              }}
            />
          ))}
          ...
          <div style={{ textAlign: "center", padding: "2rem 0" }}>
            <div
              style={{
                ...
                height: 56,
                borderRadius: "50%",
                background: "rgba(126,184,132,0.15)",
                border: "1px solid rgba(126,184,132,0.3)",
                display: "flex",
                alignItems: "center",
            ...
            >
              That was a live EdinForm — clean, fast, distraction-free.
            </p>
            <button
              onClick={() => {
                setStep(0);
                ...
                {current.options!.map((opt) => (
                  <button
                    ...
                    style={{
                      ...
                      border:
                        "1px solid " +
                        (selected === opt ? "rgba(200,155,99,0.5)" : "rgba(255,255,255,0.08)"),
                      background:
                        selected === opt ? "rgba(200,155,99,0.10)" : "rgba(255,255,255,0.02)",
            ...
            {current.type === "text" && (
              <textarea
                ...
                style={{
                  ...
                  padding: "12px 14px",
                  border:
                    "1px solid " + (typed ? "rgba(200,155,99,0.3)" : "rgba(255,255,255,0.08)"),
                  background: "rgba(255,255,255,0.03)",
                  color: "var(--foreground)",
                  fontSize: "13px",
                  resize: "none",
              ...
              <div style={{ textAlign: "center", padding: "1.5rem 0 2rem" }}>
                <div
                  style={{
                    ...
                    borderRadius: "50%",
                    background:
                      "linear-gradient(135deg, rgba(200,155,99,0.2), rgba(126,184,132,0.15))",
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            border:
                              "1px solid " +
                              (active ? "rgba(200,155,99,0.55)" : "rgba(255,255,255,0.07)"),
                ...
                {current.type === "multiline" && (
                  <textarea
                    ...
                    style={{
                      ...
                      border:
                        "1px solid " +
                        (answer ? "rgba(200,155,99,0.35)" : "rgba(255,255,255,0.08)"),
                      background: "rgba(255,255,255,0.03)",
                      color: "var(--foreground)",
                      fontSize: "14px",
                      resize: "none",
                    ...
                    onFocus={(e) => {
                      e.currentTarget.style.borderColor = "rgba(200,155,99,0.5)";
                    }}
                    onBlur={(e) => {
                      e.currentTarget.style.borderColor = answer
                        ? "rgba(200,155,99,0.35)"
                        : "rgba(255,255,255,0.08)";
                    }}
                  />
                )}
                    ...
                    {questions.map((_, i) => (
                      <div
                        ...
                        style={{
                          ...
                          borderRadius: "999px",
                          background:
                            i < step ? "#7EB884" : i === step ? "#C89B63" : "rgba(255,255,255,0.1)",
                          transition: "all 0.3s",
                        }}
                      />
                    ))}
            ...
            {questions.map((q, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {done || submitted ? (
                      <Check style={{ width: 10, height: 10, color: "#7EB884" }} />
                    ) : (
                      <span
                        style={{
                          width: 5,
                          height: 5,
                          borderRadius: "50%",
                          background: isCurrent ? "#C89B63" : "rgba(255,255,255,0.2)",
                        }}
                      />
                    )}
                  </div>
                  <div style={{ minWidth: 0 }}>
                    ...
                    {ans ? (
                      ...
                      >
                        {q.type === "email" ? "✉ " : ""}
                        {String(ans).length > 40 ? String(ans).slice(0, 40) + "…" : String(ans)}
                      </div>
                    ) : (
                      <div
                        style={{
    ...
    <div className="min-h-screen marketing-page relative">
      ...
      <section style={{ position: "relative", overflow: "hidden", padding: "3rem 1.5rem 0" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          >
            <div
              style={{ flex: "1 1 380px", minWidth: 0, animation: "fadeUp 0.8s ease 0.5s both" }}
            >
              <HeroFormCard />
            </div>
            <div
              style={{ flex: "1 1 340px", minWidth: 0, animation: "fadeUp 0.8s ease 0.6s both" }}
            >
              <div style={{ marginBottom: "1.5rem" }}>
                <p
                  style={{
                ...
                >
                  The form on the left is live — fill it out and see EdinForm from your respondents'
                  perspective. Everything from field focus to progress animation is intentional.
                </p>
              </div>
              <FormFlowDiagram />
            </div>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
              ...
              >
                EdinForm removes every unnecessary step between asking a question and understanding
                the answer.
              </p>
            </div>
          </Reveal>
            ...
            {[
              {
                ...
                body: "Choose from 9 field types — short text, long text, multiple choice, rating, date picker, file upload, email, number, and scale. Reorder with drag-and-drop.",
                color: "#C89B63",
              },
              {
                n: "02",
                title: "Add logic & branching",
                body: "Define skip logic and conditional display rules. Respondents get a path tailored to their answers. Works on any field, no code required.",
                color: "#7EB884",
              },
              {
                n: "03",
                title: "Publish in one click",
                body: "Generate a shareable URL, embed snippet, or QR code. Your form works on any device, in any browser, no account needed for respondents.",
                color: "#6B9ECC",
              },
              {
                n: "04",
                title: "Read and act on replies",
                body: "Responses appear in real time. Filter, search, export to CSV. View aggregate charts or individual submissions — your data, your way.",
                color: "#C89B63",
              },
      ...
      <section
        style={{
          ...
          background: "rgba(200,155,99,0.015)",
        }}
      >
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "3rem", alignItems: "flex-start" }}>
            <Reveal style={{ flex: "1 1 300px" }}>
              ...
              >
                A single form that shows different questions to different people. With EdinForm, you
                set simple if/then rules on any field. The form adapts in real time — showing only
                what matters to each respondent.
              </p>
              <p
                style={{
                  fontSize: "15px",
              ...
              >
                The result: shorter, more relevant forms. Higher completion rates. Better data
                quality. Less cleanup on your end.
              </p>
            </Reveal>
            <Reveal delay={120} style={{ flex: "1 1 380px" }}>
              <div
                style={{
                  background: "rgba(126,184,132,0.04)",
                  border: "1px solid rgba(126,184,132,0.12)",
                  borderRadius: "20px",
                  padding: "1.75rem",
                }}
              >
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
              ...
              >
                A real EdinForm, live right here.
              </h2>
              <p
                style={{
                  maxWidth: "50ch",
              ...
              >
                This isn't a mockup. Every interaction — field focus, validation, progress,
                submission — is exactly what your respondents will experience.
              </p>
            </div>
          </Reveal>
          <Reveal delay={100}>
              ...
              {[
                {
                  ...
                  desc: "Submissions appear in your dashboard in real time",
                },
                {
                  icon: GitBranch,
                  label: "Adaptive logic",
                  desc: "Questions change based on previous answers",
                },
                {
                  icon: Globe,
                  label: "Works everywhere",
                  desc: "Any device, any browser — no app needed",
                },
                {
                  icon: BarChart3,
                  label: "Built-in analytics",
                  desc: "Completion rates, drop-off, and timing tracked automatically",
                },
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "3rem", alignItems: "flex-start" }}>
            <Reveal style={{ flex: "1 1 300px" }}>
              ...
              >
                EdinForm tracks the metrics that tell you whether your form is working — not just
                how many responses you received. See where respondents drop off, which questions
                take the longest to answer, and how completion rates change over time.
              </p>
              <p
                style={{
                  fontSize: "15px",
              ...
              >
                Export everything to CSV or JSON. Filter by date range, device type, or referrer.
                Build a picture of your audience — without leaving your dashboard.
              </p>
            </Reveal>
      ...
      <section
        id="features"
        style={{ padding: "7rem 1.5rem", borderBottom: "1px solid var(--border)" }}
      >
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <Reveal>
            <div style={{ marginBottom: "4rem" }}>
              ...
              >
                Most form tools stop at collecting responses. EdinForm goes further — giving you
                logic, analytics, collaboration, and integrations in one place.
              </p>
            </div>
          </Reveal>
            ...
            {[
              {
                ...
                body: "Short text, long text, multiple choice, checkboxes, rating scale, date picker, file upload, email validation, and number input — all styled consistently and accessible by default.",
                color: "#C89B63",
              },
              {
                icon: GitBranch,
                ...
                body: "Skip irrelevant questions, show fields only when needed, redirect to custom endings. Build complex decision trees without writing a single line of code.",
                color: "#7EB884",
              },
              {
                icon: Eye,
                ...
                body: "See your form exactly as respondents will — including all conditional logic paths — before you publish. Catch issues before they reach your audience.",
                color: "#6B9ECC",
              },
              {
                icon: BarChart3,
                ...
                body: "View total responses, completion rates, average time-to-complete, and drop-off points. Per-question summaries and response distribution charts included.",
                color: "#C89B63",
              },
              {
                icon: ShieldCheck,
                n: "05",
                title: "Spam protection & validation",
                body: "Rate limiting, honeypot fields, and email validation keep your data clean. Optional CAPTCHA integration available on all plans.",
                color: "#7EB884",
              },
              {
                icon: Share2,
                ...
                body: "Share a public link, restrict access with a password, or embed directly in your website. Generate QR codes for offline use. All responses stream in live.",
                color: "#6B9ECC",
              },
              {
                icon: Zap,
                ...
                body: "Fire a webhook on every submission. Connect to Zapier, Make, or direct REST endpoints to route responses wherever your workflow lives.",
                color: "#C89B63",
              },
              {
                icon: Users,
                ...
                body: "Invite teammates as editors or viewers. Comment on questions, review drafts, and publish together — with full audit history on paid plans.",
                color: "#7EB884",
              },
              {
                icon: Globe,
                ...
                body: "Serve forms from your own domain, swap the logo, customize the color palette and font. Your form should look like you, not like a form tool.",
                color: "#6B9ECC",
              },
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "1.25rem" }}>
            {[
              ...
              },
              {
                ...
                name: "Marcus K.",
                role: "Product Designer, Mono",
                stars: 5,
              },
              {
                q: "Clients mention the forms. That never happened before. They say things like 'that felt polished'. That's EdinForm.",
                name: "Priya R.",
                role: "Studio Lead, Forma",
                stars: 5,
              },
              {
                q: "Completion rates went up 34% when we switched. I attribute most of that to the cleaner interface and conditional logic eliminating irrelevant questions.",
                name: "Tom H.",
                role: "Growth Lead, Layers",
                stars: 5,
              },
              {
                q: "The analytics are genuinely useful. I can see exactly where people abandon the form and fix it. Before EdinForm I was guessing.",
                name: "Sara L.",
                role: "UX Researcher, Craft",
                stars: 5,
              },
              {
                q: "We run all our user interviews through EdinForm now. The embed is clean and our completion rates reflect that.",
                name: "James O.",
                role: "Design Lead, Arc",
                stars: 5,
              },
              ...
              <Reveal key={name} delay={i * 50} style={{ flex: "1 1 280px" }}>
                <div
                  ...
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLElement).style.transform = "translateY(-5px)";
                    (e.currentTarget as HTMLElement).style.boxShadow =
                      "0 16px 48px rgba(200,155,99,0.10)";
                  }}
                  onMouseLeave={(e) => {
                    (e.currentTarget as HTMLElement).style.transform = "";
                    (e.currentTarget as HTMLElement).style.boxShadow = "";
                ...
                >
                  <div style={{ display: "flex", gap: "2px", marginBottom: "1rem" }}>
                    {Array.from({ length: stars }).map((_, i) => (
                      <Star
                        key={i}
                        style={{ width: 13, height: 13, fill: "#C89B63", color: "#C89B63" }}
                      />
                    ))}
                  </div>
                  <blockquote
              ...
              <Reveal key={q} delay={i * 40}>
                <div
                  style={{
                    ...
                    border:
                      "1px solid " +
                      (activeFaq === i ? "rgba(200,155,99,0.3)" : "rgba(255,255,255,0.06)"),
                    overflow: "hidden",
      ...
      <section style={{ padding: "8rem 1.5rem", position: "relative", overflow: "hidden" }}>
        <div
          style={{
            ...
            zIndex: 0,
            background:
              "radial-gradient(ellipse 70% 70% at 50% 50%, rgba(200,155,99,0.10) 0%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
        <div
        ...
        >
          <Reveal>
            ...
            >
              ...
              <br />
              starts <em style={{ color: "#C89B63" }}>here.</em>
            </h2>
            <p
              style={{
                maxWidth: "42ch",
            ...
            >
              ...
              answers. Free plan available — no credit card, no time limit, no catch.
            </p>
            <div
              style={{
                display: "flex",
            ...
            >
              <Link
                ...
                onMouseEnter={(e) => {
                  ...
                  (e.currentTarget as HTMLElement).style.boxShadow =
                    "0 8px 40px rgba(200,155,99,0.5)";
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLElement).style.transform = "";
                  (e.currentTarget as HTMLElement).style.boxShadow =
                    "0 4px 24px rgba(200,155,99,0.35)";
                }}
              >
